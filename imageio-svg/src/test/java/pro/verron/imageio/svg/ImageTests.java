...
import pro.verron.imageio.svg.utils.ContextFactory;
import pro.verron.imageio.svg.utils.OfficeStamperTest;

import java.nio.file.Path;

import static pro.verron.imageio.svg.utils.ResourceUtils.getImage;
import static pro.verron.imageio.svg.utils.ResourceUtils.getWordResource;
...
@DisplayName("Image-related Features") class ImageTests
    ...
    void svgReplacementInGlobalParagraphsTestWithMaxWidth(ContextFactory factory) {
        ...
        var context = factory.image(getImage(Path.of("sample.svg"), 100));
    ...
    void svgReplacementInGlobalParagraphsTest(ContextFactory factory) {
        var configuration = standard();
        var context = factory.image(getImage(Path.of("sample.svg")));
        var template = getWordResource(Path.of("ImageReplacementInGlobalParagraphsTest.docx"));
        var expected = """
                == Image Replacement in global paragraphs
